...
#
#  -hud_port
#   Defines the TCP port used to real-time HUD progress interface between ffmpeg and fsrifs.
#
#  -verbose
...
# =====================================================================
$Global:FSRIFS_ROOT = $PSScriptRoot
$pastaFunctions = Join-Path $Global:FSRIFS_ROOT "functions"
